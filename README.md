...
[![Last updated](https://img.shields.io/github/last-commit/philiprehberger/py-git-analyzer)](https://github.com/philiprehberger/py-git-analyzer/commits/main)
...
⭐ [Star the repo](https://github.com/philiprehberger/py-git-analyzer)

🐛 [Report issues](https://github.com/philiprehberger/py-git-analyzer/issues?q=is%3Aissue+is%3Aopen+label%3Abug)

💡 [Suggest features](https://github.com/philiprehberger/py-git-analyzer/issues?q=is%3Aissue+is%3Aopen+label%3Aenhancement)
